...
interface ICoreVaultManager {
    ...
    // Events
    event PaymentConfirmed(bytes32 indexed transactionId, uint256 amount);
    ...
    function triggerInstructions()
        external
        returns (uint256 _numberOfInstructions);
     ...
     */
    function getAllowedDestinationAddresses()
        external
        view
     ...
     */
    function isDestinationAddressAllowed(
     ...
     * @return Escrow.
     */
    function getEscrowByPreimageHash(
     ...
     */
    function getCancelableTransferRequests()
        external
        view
     ...
     */
    function getNonCancelableTransferRequests()
        external
        view
        returns (TransferRequest[] memory);
