...
interface IWalletProjectManager is ITeeCommonErrors {
    ...
    event NewOwnerProposed(bytes32 indexed projectId, address indexed newOwner);
    ...
    function getExtensionId(
        bytes32 _projectId
    ) external view returns (uint256 _extensionId);
    ...
    function getKeyType(
        bytes32 _projectId
    ) external view returns (bytes32 _keyType);
    ...
    function getSigningAlgo(
        bytes32 _projectId
    ) external view returns (bytes32 _signingAlgo);
    ...
    function getBackupManager(
        bytes32 _projectId
    ) external view returns (address _backupManager);
}
