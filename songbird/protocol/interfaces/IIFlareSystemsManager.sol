...
interface IIFlareSystemsManager is IFlareSystemsManager {
     ...
     */
    function noOfWeightBasedClaims(
        uint256 _rewardEpochId,
     ...
     * @param _rewardEpochId Reward epoch id.
     */
    function noOfWeightBasedClaimsHash(
        uint256 _rewardEpochId
    ) external view returns (bytes32);
     ...
     */
    function randomAcquisitionMaxDurationSeconds()
        external
        view
        returns (uint64);
     ...
     */
    function randomAcquisitionMaxDurationBlocks()
        external
        view
        returns (uint64);
     ...
     */
    function newSigningPolicyInitializationStartSeconds()
        external
        view
        returns (uint64);
     ...
     */
    function newSigningPolicyMinNumberOfVotingRoundsDelay()
        external
        view
        returns (uint32);
     ...
     */
    function voterRegistrationMinDurationSeconds()
        external
        view
        returns (uint64);
     ...
     */
    function voterRegistrationMinDurationBlocks()
        external
        view
        returns (uint64);
     ...
     */
    function submitUptimeVoteMinDurationSeconds()
        external
        view
        returns (uint64);
     ...
     */
    function currentRewardEpochExpectedEndTs()
        external
        view
        returns (uint64 _currentRewardEpochExpectedEndTs);

    /**
     * The last voting round id that was initialized.
     */
    function lastInitializedVotingRoundId()
        external
        view
        returns (uint32 _lastInitializedVotingRoundId);

    /**
     * The reward epoch id that will expire next.
     */
    function rewardEpochIdToExpireNext()
        external
        view
        returns (uint24 _rewardEpochIdToExpireNext);
     ...
     */
    function getRewardEpochStartInfo(
        uint24 _rewardEpochId
    )
        external
        view
        returns (uint64 _rewardEpochStartTs, uint64 _rewardEpochStartBlock);
     ...
     */
    function getRandomAcquisitionInfo(
        uint24 _rewardEpochId
    )
        external
        view
     ...
     */
    function getVoterSigningPolicySignInfo(
        uint24 _rewardEpochId,
        address _voter
    )
        external
        view
        returns (uint64 _signingPolicySignTs, uint64 _signingPolicySignBlock);
     ...
     */
    function getSigningPolicySignInfo(
        uint24 _rewardEpochId
    )
        external
        view
     ...
     */
    function getVoterUptimeVoteSubmitInfo(
        uint24 _rewardEpochId,
        address _voter
    )
        external
        view
        returns (uint64 _uptimeVoteSubmitTs, uint64 _uptimeVoteSubmitBlock);
     ...
     */
    function getVoterUptimeVoteSignInfo(
        uint24 _rewardEpochId,
        address _voter
    )
        external
        view
        returns (uint64 _uptimeVoteSignTs, uint64 _uptimeVoteSignBlock);
     ...
     */
    function getUptimeVoteSignStartInfo(
        uint24 _rewardEpochId
    )
        external
        view
     ...
     */
    function getVoterRewardsSignInfo(
        uint24 _rewardEpochId,
        address _voter
    ) external view returns (uint64 _rewardsSignTs, uint64 _rewardsSignBlock);
