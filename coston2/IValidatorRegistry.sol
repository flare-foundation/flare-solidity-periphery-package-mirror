...
interface IValidatorRegistry {
    ...
    function getDataProviderInfo(
        ...
        external
        view
        returns (string memory _nodeId, string memory _pChainPublicKey);
     ...
     */
    function getDataProviderForNodeId(
        bytes32 _nodeId
     ...
     * @return _dataProvider Data provider's address
     */
    function getDataProviderForPChainPublicKey(
        bytes32 _pChainPublicKey
    ) external view returns (address _dataProvider);
}
