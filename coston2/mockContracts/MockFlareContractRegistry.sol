...
contract FlareContractRegistryMock is IFlareContractRegistry {
    ...
    string[] public correctContractNames = [
        ...
        ("VoterWhitelister"), ("PChainStakeMirrorVerifier"), ("Escrow"), ("WNat"), ("InflationAllocation"), ("IncentivePoolTreasury"), ("ValidatorRewardManager"), ("DistributionTreasury"), ("FtsoRegistry"), ("CleanupBlockNumberManager"), ("PollingFtso"), ("GovernanceSettings"), ("PollingFoundation"), ("IncentivePoolAllocation"), ("FlareDaemon"), ("ClaimSetupManager"), ("FtsoManager"), ("PChainStakeMirror"), ("GovernanceVotePower"), ("PChainStakeMirrorMultiSigVoting"), ("InitialAirdrop"), ("IncentivePool"), ("Inflation"), ("CombinedNat"), ("ValidatorRegistry"), ("FlareContractRegistry"), ("StateConnector"), ("AddressUpdater"), ("AddressBinder"), ("PriceSubmitter"), ("Supply"), ("DistributionToDelegators"), ("FlareAssetRegistry"), ("FtsoRewardManager") 
