...
contract FlareContractRegistryMock is IFlareContractRegistry {
    ...
    string[] public correctContractNames = [
        ...
        ("StateConnector"), ("PChainStakeMirror"), ("DistributionTreasury"), ("DistributionToDelegators"), ("PChainStakeMirrorVerifier"), ("GovernanceSettings"), ("FlareAssetRegistry"), ("ClaimSetupManager"), ("PriceSubmitter"), ("FtsoRegistry"), ("Inflation"), ("IncentivePoolTreasury"), ("Supply"), ("ValidatorRewardManager"), ("PollingFtso"), ("GovernanceVotePower"), ("CombinedNat"), ("AddressUpdater"), ("ValidatorRegistry"), ("WNat"), ("AddressBinder"), ("PChainStakeMirrorMultiSigVoting"), ("FtsoRewardManager"), ("FlareContractRegistry"), ("CleanupBlockNumberManager"), ("InflationAllocation"), ("IncentivePoolAllocation"), ("InitialAirdrop"), ("VoterWhitelister"), ("Escrow"), ("PollingFoundation"), ("IncentivePool"), ("FtsoManager"), ("FlareDaemon") 
