 ...
 */
interface IFAssetRedeemComposer is
    ILayerZeroComposer,
    IBeacon,
    IOwnableWithTimelock
{
    /**
    ...
    function isRedeemerAccount(
        address _address
    ) external view returns (bool _isRedeemerAccount, address _owner);
    ...
    function getBalances(
        address _account
    ) external view returns (AccountBalances memory _balances);
}
