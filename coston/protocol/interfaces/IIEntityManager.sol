...
interface IIEntityManager is IEntityManager {
     ...
     */
    function getDelegationAddresses(
     ...
     */
    function getSubmitAddresses(
        address[] memory _voters,
        uint256 _blockNumber
    ) external view returns (address[] memory _submitAddresses);
     ...
     */
    function getSubmitSignaturesAddresses(
        address[] memory _voters,
        uint256 _blockNumber
    ) external view returns (address[] memory _submitSignaturesAddresses);
