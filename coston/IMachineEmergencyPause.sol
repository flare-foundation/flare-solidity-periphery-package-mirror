...
interface IMachineEmergencyPause is ITeeCommonErrors {
     ...
     */
    function emergencyPauseExtension(uint256 _extensionId) external;
     ...
     */
    function emergencyUnpauseExtension(uint256 _extensionId) external;
    ...
    function isExtensionEmergencyPauser(
        uint256 _extensionId,
        address _addr
    ) external view returns (bool _isPauser);
    ...
    function isExtensionEmergencyUnpauser(
        uint256 _extensionId,
        address _addr
    ) external view returns (bool _isUnpauser);
    ...
    function isExtensionEmergencyPaused(
        uint256 _extensionId
    ) external view returns (bool _paused);
    ...
    function getLastUnpauseTs(
        uint256 _extensionId
    ) external view returns (uint64 _ts);
