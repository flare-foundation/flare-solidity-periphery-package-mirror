...
import {IFdc2Hub} from "./IFdc2Hub.sol";
import {IFdc2Verification} from "./IFdc2Verification.sol";

bytes32 constant PMW_MULTISIG_ACCOUNT_CONFIGURED_ATTESTATION_TYPE = bytes32(
    "PMWMultisigAccountConfigured"
);

interface IPMWMultisigAccountConfigured {
    enum PMWMultisigAccountStatus {
        OK,
        ERROR
    }
