...
interface IMintingTagManager is IERC721EnumerableUpgradeable {
    ...
    event AllowedExecutorChangePending(
        uint256 tag,
        address executor,
     ...
     */
    function pendingAllowedExecutorChange(
        uint256 _mintingTag
    )
        external
        view
